...
import { KeyRound, ShieldAlert, UserCheck, ArrowLeft } from "lucide-react";
            ...
            <div className="space-y-5">
              <div className="p-5 bg-amber-500/10 border border-amber-500/20 text-slate-200 rounded-2xl text-xs space-y-3">
                ...
                <p className="text-slate-300 leading-relaxed">
                  ...
                  <strong className="text-white">Viz Giron</strong> (Creator &
                  System Developer) for assistance.
                </p>
                <div className="pt-2 border-t border-amber-500/20 flex items-center space-x-2 text-slate-400">
                  <UserCheck className="w-4 h-4 text-emerald-400 shrink-0" />
                  <span>
                    Your password can be securely reset after your identity is
                    verified.
                  </span>
                </div>
              </div>
