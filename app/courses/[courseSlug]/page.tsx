        ...
        <header className="bg-white rounded-3xl p-8 sm:p-10 border border-slate-200/80 shadow-sm relative overflow-hidden space-y-8">
          ...
          <div className="bg-slate-50/80 rounded-2xl p-5 border border-slate-200/60 space-y-3">
            ...
            <div className="w-full bg-slate-200/80 rounded-full h-2 overflow-hidden">
              <div className="bg-blue-600 h-full rounded-full transition-all duration-500 w-[0%]" />
            </div>
              ...
              {lessons.map((lesson) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    <div className="w-10 h-10 rounded-xl bg-slate-100 group-hover:bg-blue-50 text-slate-600 group-hover:text-blue-600 font-bold text-sm flex items-center justify-center shrink-0 transition-colors">
                  ...
                  <Link
                    href={`/courses/${course.slug}/lessons/${lesson.slug || lesson.lesson_number}`}
                    className="inline-flex items-center justify-center gap-2 bg-slate-900 hover:bg-blue-600 text-white text-xs font-semibold px-4 py-2.5 rounded-xl transition-all shadow-sm shrink-0"
                  >
